...
final instructorsChooseOptionRepositoryProvider = StateNotifierProvider<
...
final instructorsChooseOptionProvider =
    Provider<AsyncValue<List<StudentModel>>>((ref) => ref
        .watch(instructorsChooseOptionRepositoryProvider)
