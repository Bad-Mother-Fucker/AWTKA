...
StudentRelationModel _$StudentRelationModelFromJson(Map<String, dynamic> json) {
  return _StudentRelationModel.fromJson(json);
}

/// @nodoc
mixin _$StudentRelationModel {
  String? get id => throw _privateConstructorUsedError;
  String? get address => throw _privateConstructorUsedError;
  DateTime? get dob => throw _privateConstructorUsedError;
  String get email => throw _privateConstructorUsedError;
  String get last_name => throw _privateConstructorUsedError;
  String get name => throw _privateConstructorUsedError;
  String get student_level => throw _privateConstructorUsedError;
  String get student_shirt_color => throw _privateConstructorUsedError;
  String get telephone => throw _privateConstructorUsedError;
  bool get instructor => throw _privateConstructorUsedError;
  DateTime? get created => throw _privateConstructorUsedError;
  DateTime? get updated => throw _privateConstructorUsedError;
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $StudentRelationModelCopyWith<StudentRelationModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StudentRelationModelCopyWith<$Res> {
  factory $StudentRelationModelCopyWith(StudentRelationModel value,
          $Res Function(StudentRelationModel) then) =
      _$StudentRelationModelCopyWithImpl<$Res, StudentRelationModel>;
  @useResult
  $Res call(
      {String? id,
      String? address,
...
/// @nodoc
class _$StudentRelationModelCopyWithImpl<$Res,
        $Val extends StudentRelationModel>
    implements $StudentRelationModelCopyWith<$Res> {
  _$StudentRelationModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_StudentRelationModelCopyWith<$Res>
    implements $StudentRelationModelCopyWith<$Res> {
  factory _$$_StudentRelationModelCopyWith(_$_StudentRelationModel value,
          $Res Function(_$_StudentRelationModel) then) =
      __$$_StudentRelationModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? id,
...
/// @nodoc
class __$$_StudentRelationModelCopyWithImpl<$Res>
    extends _$StudentRelationModelCopyWithImpl<$Res, _$_StudentRelationModel>
    implements _$$_StudentRelationModelCopyWith<$Res> {
  __$$_StudentRelationModelCopyWithImpl(_$_StudentRelationModel _value,
      $Res Function(_$_StudentRelationModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_StudentRelationModel(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_StudentRelationModel
    with DiagnosticableTreeMixin
    implements _StudentRelationModel {
  const _$_StudentRelationModel(
      {this.id,
      required this.address,
      required this.dob,
      required this.email,
  ...
  factory _$_StudentRelationModel.fromJson(Map<String, dynamic> json) =>
      _$$_StudentRelationModelFromJson(json);
  ...
  final String name;
  @override
  final String student_level;
  @override
  final String student_shirt_color;
  @override
  final String telephone;
  @override
  final bool instructor;
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'StudentRelationModel(id: $id, address: $address, dob: $dob, email: $email, last_name: $last_name, name: $name, student_level: $student_level, student_shirt_color: $student_shirt_color, telephone: $telephone, instructor: $instructor, created: $created, updated: $updated, collectionId: $collectionId, collectionName: $collectionName, avatar: $avatar, certificates: $certificates, certificates_type: $certificates_type, certificates_size: $certificates_size, certificates_date: $certificates_date, contracts: $contracts, contracts_type: $contracts_type, contracts_size: $contracts_size, contracts_date: $contracts_date, notes: $notes)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'StudentRelationModel'))
      ..add(DiagnosticsProperty('id', id))
      ..add(DiagnosticsProperty('address', address))
      ..add(DiagnosticsProperty('dob', dob))
      ..add(DiagnosticsProperty('email', email))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_StudentRelationModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.address, address) || other.address == address) &&
            (identical(other.dob, dob) || other.dob == dob) &&
            (identical(other.email, email) || other.email == email) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_StudentRelationModelCopyWith<_$_StudentRelationModel> get copyWith =>
      __$$_StudentRelationModelCopyWithImpl<_$_StudentRelationModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_StudentRelationModelToJson(
      this,
    );
  }
}

abstract class _StudentRelationModel implements StudentRelationModel {
  const factory _StudentRelationModel(
      {final String? id,
      required final String? address,
      required final DateTime? dob,
      required final String email,
      required final String last_name,
      required final String name,
      required final String student_level,
      required final String student_shirt_color,
      required final String telephone,
      required final bool instructor,
      final DateTime? created,
      final DateTime? updated,
      ...
      final int? contracts_size,
      final DateTime? contracts_date,
      final String? notes}) = _$_StudentRelationModel;

  factory _StudentRelationModel.fromJson(Map<String, dynamic> json) =
      _$_StudentRelationModel.fromJson;
  ...
  String get name;
  @override
  String get student_level;
  @override
  String get student_shirt_color;
  @override
  String get telephone;
  @override
  bool get instructor;
